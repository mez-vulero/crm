...
fixtures = [
	{
		...
		"filters": [["fieldname", "like", "re_%"], ["dt", "in", ["CRM Deal", "CRM Lead"]]],
	}
]
...
scheduler_events = {
	...
	"daily": [
		...
		"crm.fcrm.doctype.unit_reservation.unit_reservation.expire_soft_reservations",
	],
	...
	"cron": {
		"*/5 * * * *": [
			...
			"crm.integrations.websprix.api.sync_call_logs_for_all_agents",
		],
