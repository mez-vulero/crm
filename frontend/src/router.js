...
const routes = [
  ...
  {
    alias: '/real-estate',
    path: '/real-estate/view/:viewType?',
    name: 'Real Estate',
    component: () => import('@/pages/RealEstate.vue'),
  },
  {
    path: '/real-estate/:projectId',
    name: 'RealEstateProject',
    component: () => import('@/pages/RealEstateProject.vue'),
    props: true,
  },
  {
    alias: '/commissions',
    path: '/commissions/view/:viewType?',
    name: 'Commissions',
  ...
  if (isLoggedIn && to.name !== 'Not Permitted' && !isCrmUser()) {
    ...
    if (!viewType) {
      const doctypeMap = {
        ...
        'Real Estate': 'Real Estate Project',
